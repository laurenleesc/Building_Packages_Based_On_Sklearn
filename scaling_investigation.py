...
print('Our current dataset has the highest beta/signal of', max_, ', a kappa of ', kappa,', and ',p_,'dimensions and ',n_,' observations. What would happen if we were to scale our data prior to our MLE?')
print('First, lets see without normalizing the data.')

#first, let's see without scaling the data:
...
#next, let's see WITH scaling the data:

print('Now, lets see WITH normalizing the data.')
